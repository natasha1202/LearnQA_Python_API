...
# <RequestsCookieJar[Cookie(version=0, name='HomeWork', value='hw_value', port=None, port_specified=False,
# domain='.play...ure=False, expires=1700613421, discard=False, comment=None, comment_url=None, rest={'HttpOnly':
# None}, rfc2109=False)]>
